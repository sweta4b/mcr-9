...
function SingleVideo() {
  ...
  const [showPlaylist, setShowPlaylist] = useState(false);
    ...
    return (
      ...
      {
                showPlaylist && <EditNote editNote={editNote} setEditNote={setEditNote} notes={notes} setNotes={setNotes} setNoteData={setNoteData}/>
            }
             <Modal
        aria-labelledby="transition-modal-title"
        aria-describedby="transition-modal-description"
      ...
      >
        <Fade in={showPlaylist}>
          <Box sx={style}>
            ...
            <input placeholder='Enter title of the playlist'onChange={(event) => setNotes(event.target.value)}/>
            <input placeholder='Write a description'onChange={(event) => setNotes(event.target.value)}/>
